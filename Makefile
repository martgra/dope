...
lint:
	uv run ruff check dope tests

format:
	uv run ruff format dope tests

run:
	uv run python dope/__main__.py
...
github-create: .check-gh
	...
	@echo "🚀 Creating GitHub repository martgra/dope..."
	@gh repo create martgra/dope --public --source=. --remote=origin
	@echo "✅ Repository created at: https://github.com/martgra/dope"
	@echo ""
...
github-push: .check-gh
	...
	@echo "🔗 View at: https://github.com/martgra/dope"
