...
def get_service_logger(service_name: str) -> logging.Logger:
    """Get a logger for a service module.

    Args:
        service_name: Name of the service (e.g., 'describer', 'suggester').

    Returns:
        Configured logger instance.
    """
    ensure_logging_configured()
    return logging.getLogger(f"dope.services.{service_name}")


def get_cli_logger() -> logging.Logger:
    """Get a logger for CLI commands.

    Returns:
        Configured logger instance for CLI.
    """
    ensure_logging_configured()
    return logging.getLogger("dope.cli")
...
def get_core_logger(module_name: str) -> logging.Logger:
    ...
    Args:
        module_name: Name of the core module.

    Returns:
        Configured logger instance.
    """
    ensure_logging_configured()
    return logging.getLogger(f"dope.core.{module_name}")
